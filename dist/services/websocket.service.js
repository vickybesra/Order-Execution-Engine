...
class WebSocketService {
    connections = new Map();
    orderConnections = new Map(); // orderId -> Set of connectionIds
    /**
     ...
     */
    registerConnection(socket, orderId) {
     ...
     */
    emitStatusUpdate(orderId, statusUpdate) {
        ...
        console.log(`[WebSocketService] Emitted status update for order ${orderId}: ${statusUpdate.status} ` +
            `(sent: ${sentCount}, failed: ${failedCount})`);
    }
    /**
     * Get the number of active connections for an order
     */
    getConnectionCount(orderId) {
